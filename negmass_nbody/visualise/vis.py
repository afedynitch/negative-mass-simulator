...
def make_videos():
    ...
    for i in range(0, index):
        if os.path.isfile("./DATA/img3d-" + str(i) + ".png") is True:
            ...
            os.system('/usr/local/bin/magick ' + './DATA/img3d-' + str(i) +
                      '.png' + ' ./DATA/JPGS/img3d-' + str(i) + '.jpg')

    # Now combine all files together into an animation:
    os.system('/usr/local/bin/magick -delay 5 -loop 0' + files +
              './DATA/img3d-movie.mp4')
